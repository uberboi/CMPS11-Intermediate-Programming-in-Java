...
//lab5
//
// Error1: The ">=" sign should be only ">" then so it does not evaluate sentenceCode: 5
// as an invalid code.
//
//Error2: The ";" should be removed after "if(m == 2);" so it does not ignore the
// if statement and reevaluates the word as "foggy."
//
//Error3: The ";" should be removed after "}else; " so it does not create a new if statement 
// that evaluates the phrase as "ERROR" if the modifierCode is not equal to 3.
//---------------------------------------------------------------------------------------
